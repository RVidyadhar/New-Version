...
class minconNLP : public TNLP
{
	...
	Index flag1_;                   //Gradient of objective ON or OFF

    Index flag2_;			 //Hessian of objective ON or OFF

	Index flag3_;                   //Jacobian of constraints ON or OFF

	Index nonlinCon_;               //Number of non-linear constraints

	Index nonlinIneqCon_;		 //Number of non-linear inequality constraints
